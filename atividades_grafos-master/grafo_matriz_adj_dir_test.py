...
class TestGrafo(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.g_d0 = MeuGrafo()
        self.g_d0.adiciona_vertice("A")
        self.g_d0.adiciona_vertice("B")
        self.g_d0.adiciona_vertice("C")
        self.g_d0.adiciona_vertice("D")
        self.g_d0.adiciona_vertice("E")
        self.g_d0.adiciona_vertice("F")
        self.g_d0.adiciona_vertice("G")
        self.g_d0.adiciona_aresta("a1", "A", "B", 1)
        self.g_d0.adiciona_aresta("a2", "B", "C", 1)
        self.g_d0.adiciona_aresta("a3", "B", "F", 3)
        self.g_d0.adiciona_aresta("a4", "C", "D", 1)
        self.g_d0.adiciona_aresta("a5", "C", "E", 2)
        self.g_d0.adiciona_aresta("a6", "D", "E", 3)
        self.g_d0.adiciona_aresta("a7", "E", "G", 2)
        self.g_d0.adiciona_aresta("a8", "F", "G", 1)
        ...
        self.g_d0_m = self.constroi_matriz(self.g_d0)
        self.g_d0_m[0][1] = 1
        self.g_d0_m[0][2] = 1
        self.g_d0_m[0][3] = 1
        self.g_d0_m[0][4] = 1
        ...
        self.p_t.adiciona_aresta('a2', 'A', 'C', 1)
        self.p_t.adiciona_aresta('a3', 'C', 'D', 3)
        self.p_t.adiciona_aresta('a4', 'B', 'D', 1)
        self.p_t.adiciona_aresta('a5', 'C', 'F', 15)
        self.p_t.adiciona_aresta('a6', 'D', 'E', 2)
        self.p_t.adiciona_aresta('a7', 'E', 'F', 3)
        self.p_t.dijkstra('A', 'F')
    ...
    def test_warshall(self):
        ...
        self.assertEqual(self.g_d0.warshall(), self.g_d0_m)

    def test_dijkstra(self):
        self.assertEqual(self.p_t.dijkstra('A','F'), ['A', 'B', 'D', 'E', 'F'])
        self.assertEqual(self.g_p.dijkstra('J', 'T'), ['J', 'C', 'T'])
        self.assertEqual(self.g_p.dijkstra('J', 'Z'), ['J', 'C', 'T', 'Z'])
        self.assertEqual(self.g_p.dijkstra('J', 'M'), ['J', 'C', 'M'])
        self.assertEqual(self.g_p.dijkstra('J', 'C'), ['J', 'C'])
        self.assertEqual(self.g_p.dijkstra('J', 'E'), ['J', 'C', 'E'])
        self.assertEqual(self.g_p.dijkstra('J', 'P'), ['J', 'C', 'P'])
        self.assertEqual(self.g_p.dijkstra('Z', 'J'), ['Z', 'T', 'C', 'J'])
        self.assertEqual(self.g_p.dijkstra('Z', 'M'), ['Z', 'T', 'M'])
        self.assertEqual(self.g_p.dijkstra('Z', 'C'), ['Z', 'T', 'C'])
        self.assertEqual(self.g_p.dijkstra('Z', 'E'), ['Z', 'T','C', 'E'])
        self.assertEqual(self.g_p.dijkstra('Z', 'P'), ['Z', 'T','C', 'P'])
        self.assertEqual(self.g_p.dijkstra('M', 'J'), ['M', 'C', 'J'])
        self.assertEqual(self.g_p2.dijkstra('J', 'T'), ['J', 'C', 'T'])
        self.assertEqual(self.g_p2.dijkstra('J', 'Z'), ['J', 'C', 'T', 'Z'])
        self.assertEqual(self.g_p2.dijkstra('J', 'M'), ['J', 'C', 'M'])
        self.assertEqual(self.g_p2.dijkstra('J', 'C'), ['J', 'C'])
        self.assertEqual(self.g_p2.dijkstra('J', 'E'), ['J', 'C', 'E'])
        self.assertEqual(self.g_p2.dijkstra('J', 'P'), ['J', 'C', 'P'])
        self.assertEqual(self.g_p2.dijkstra('Z', 'J'), ['Z', 'T', 'C', 'J'])
        self.assertEqual(self.g_p2.dijkstra('Z', 'M'), ['Z', 'T', 'M'])
        self.assertEqual(self.g_p2.dijkstra('Z', 'C'), ['Z', 'T', 'C'])
        self.assertEqual(self.g_p2.dijkstra('Z', 'E'), ['Z', 'T','C', 'E'])
        self.assertEqual(self.g_p2.dijkstra('Z', 'P'), ['Z', 'T','C', 'P'])
        self.assertEqual(self.g_p2.dijkstra('Z', 'T'), ['Z', 'T'])
        self.assertEqual(self.g_p2.dijkstra('M', 'J'), ['M', 'C', 'J'])
        self.assertEqual(self.g_p2.dijkstra('M', 'Z'), ['M', 'T', 'Z'])
        self.assertEqual(self.g_p2.dijkstra('M', 'C'), ['M', 'C'])
        self.assertEqual(self.g_p3.dijkstra('M', 'E'), ['M', 'C', 'E'])
        self.assertEqual(self.g_p3.dijkstra('M', 'P'), ['M', 'C', 'P'])
        self.assertEqual(self.g_p_sem_paralelas.dijkstra('J', 'T'), ['J', 'C', 'T'])
        self.assertEqual(self.g_p_sem_paralelas.dijkstra('J', 'Z'), ['J', 'C', 'T', 'Z'])
        self.assertEqual(self.g_p_sem_paralelas.dijkstra('J', 'M'), ['J', 'C', 'M'])
        self.assertEqual(self.g_p4.dijkstra('J', 'C'), ['J', 'C'])
        self.assertEqual(self.g_p4.dijkstra('J', 'E'), ['J', 'E'])
        self.assertEqual(self.g_p4.dijkstra('J', 'P'), ['J','C', 'P'])
